// suffix tries: http://www.heppenstall.ca/academics/doc/242/F2001Archives/Ch11_3_tries.pdf
// github: https://github.com/martijnversluis/JsSuffixTrie
...
JsSuffixTrie.prototype.contains = function (string) {
    ...
    return node !== null && (node.terminator == undefined || node.terminator);
};
...
JsSuffixTrie.prototype.find = function (prefix) {
    ...
    if (node)
        return JsSuffixTrie.nodeToArray(node, prefix);
    else
        return null;
};
